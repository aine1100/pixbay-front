            ...
            <div className="max-w-[1100px] mx-auto px-6 pt-6">
                ...
                <div className="flex items-center justify-between py-4 mb-6">
                    <Link
                        ...
                        className="flex items-center gap-2.5 text-slate-500 hover:text-primary transition-all font-medium text-sm group"
                    >
                    ...
                    <div className="flex items-center gap-3">
                        <span className="text-[10px] font-medium text-slate-300 tracking-widest uppercase">Booking ID: {booking.bookingNumber || id.slice(0, 8).toUpperCase()}</span>
                        <div className={cn(
                            ...
                            booking.status === "PENDING" ? "bg-orange-50 text-orange-600 border-orange-100" :
                                booking.status === "CONFIRMED" ? "bg-blue-50 text-blue-600 border-blue-100" :
                                    booking.status === "IN_PROGRESS" ? "bg-green-50 text-green-600 border-green-100" :
                ...
                <div className="grid lg:grid-cols-3 gap-10">
                    ...
                    <div className="lg:col-span-2 space-y-10">
                        ...
                        {/* Hero Image */}
                        <div className="relative w-full h-[350px] rounded-[32px] overflow-hidden border border-slate-100 group">
                            <NextImage
                                src={heroImage}
                                alt={eventTitle}
                                fill
                            ...
                            <div className="absolute bottom-6 left-8 text-white">
                                <h1 className="text-3xl font-medium tracking-tight">{eventTitle}</h1>
                        ...
                        {/* Creator Info Card */}
                        <div className="bg-slate-50/30 rounded-[32px] p-8 space-y-6 border border-slate-100">
                            <div className="flex items-center gap-5">
                                <div className="relative w-16 h-16 rounded-2xl overflow-hidden ring-4 ring-white border border-slate-50">
                                    <NextImage
                                ...
                                <div>
                                    <h2 className="text-xl font-medium text-slate-900">Hosted by {creatorUser.firstName} {creatorUser.lastName}</h2>
                                    <div className="flex items-center gap-2 mt-0.5">
                                        <div className="flex items-center gap-1">
                                            <Star className="w-3 h-3 fill-[#FF3B30] text-[#FF3B30]" />
                                            <span className="text-xs font-medium text-slate-700">{creator.rating || "5.0"}</span>
                                        </div>
                                        <span className="text-slate-300">|</span>
                                        <p className="text-slate-500 text-xs font-medium uppercase tracking-wider">{creator.role || "Professional Creator"}</p>
                                    </div>
                                </div>
                                <button className="ml-auto p-3 bg-white hover:bg-slate-50 text-primary rounded-xl border border-slate-100 transition-all active:scale-95">
                            ...
                            <div className="grid grid-cols-2 gap-8 pt-6 border-t border-slate-200/50">
                                <div className="flex items-center gap-4 group cursor-pointer">
                                    <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center text-slate-400 group-hover:text-primary transition-all border border-slate-50">
                                        <Mail className="w-4 h-4" />
                                    </div>
                                    <div className="space-y-0.5">
                                        <p className="text-[10px] font-medium text-slate-400 uppercase tracking-widest">Creator Email</p>
                                        <p className="text-sm font-medium text-slate-700">{creatorUser.email || "Contact via Chat"}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4 group cursor-pointer">
                                    <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center text-slate-400 group-hover:text-primary transition-all border border-slate-50">
                                    ...
                                    <div className="space-y-0.5">
                                        <p className="text-[10px] font-medium text-slate-400 uppercase tracking-widest">Support Contact</p>
                                        <p className="text-sm font-medium text-slate-700">Platform Secure Line</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8 px-2">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                                <div className="p-5 bg-white border border-slate-100 rounded-2xl space-y-1">
                                    <p className="text-[9px] font-medium text-slate-400 uppercase tracking-widest">Scheduled For</p>
                                    <p className="text-sm font-medium text-slate-800">
                                        {new Date(booking.createdAt).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                                    </p>
                                </div>
                                <div className="p-5 bg-white border border-slate-100 rounded-2xl space-y-1">
                                    <p className="text-[9px] font-medium text-slate-400 uppercase tracking-widest">Service Level</p>
                                    <p className="text-sm font-medium text-slate-800">{booking.serviceType?.replace('_', ' ')}</p>
                                </div>
                                <div className="p-5 bg-white border border-slate-100 rounded-2xl space-y-1">
                                    <p className="text-[9px] font-medium text-slate-400 uppercase tracking-widest">Duration</p>
                                    <p className="text-sm font-medium text-slate-800">{bookingDetails.duration || "Standard Session"}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-8">
                        <div className="sticky top-8 bg-white border border-slate-100 rounded-[32px] p-8 space-y-8 ">
                            ...
                            <div className="space-y-1">
                                <h3 className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.2em]">Investment Summary</h3>
                                <div className="flex items-baseline gap-1">
                                    <span className="text-4xl font-medium tracking-tighter text-slate-900">${pricing.totalAmount || 0}</span>
                                    <span className="text-slate-400 font-medium text-sm tracking-tight uppercase">{pricing.currency || "USD"}</span>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 py-6 border-y border-slate-50">
                                ...
                                <div className="flex justify-between text-base font-medium text-slate-900 pt-2">
                                    <span className="uppercase tracking-widest text-[11px] font-medium text-slate-400">Total Cost</span>
                            ...
                            <div className="space-y-3">
                                ...
                                {["CONFIRMED", "COMPLETED"].includes(booking.status) && (
                                    <button
                                        ...
                                        className="w-full h-14 bg-[#16A34A] text-white rounded-2xl text-xs font-medium uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2 "
                                    >
                                ...
                                <button className="w-full h-14 bg-slate-50 text-slate-700 border border-slate-100 rounded-2xl text-xs font-medium uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2">
                                ...
                                {booking.status === "PENDING" && (
                                    <button
                                        ...
                                        className="w-full h-14 bg-red-50 text-red-500 rounded-2xl text-xs font-medium uppercase tracking-[0.2em] transition-all"
                                    >
                                        Cancel Request
                                    </button>
                                )}
                            ...
                            <div className="flex items-center gap-3 p-4 bg-orange-50/30 rounded-2xl border border-orange-100/50">
                                <AlertCircle className="w-5 h-5 text-orange-400" />
                                <p className="text-[11px] font-medium text-orange-600 leading-snug">
                            ...
                            <div className="pt-6 border-t border-slate-50 space-y-4">
                                <h4 className="text-[10px] font-medium tracking-widest uppercase text-slate-400">Booking Policies</h4>
                                <div className="space-y-3">
                                ...
                                <Link href="/client/help" className="flex items-center gap-2 text-[10px] font-medium text-primary hover:underline transition-all">
