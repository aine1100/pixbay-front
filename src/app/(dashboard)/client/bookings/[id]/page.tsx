            ...
            <div className="max-w-[1040px] mx-auto px-6 py-6">
                ...
                <div className="relative w-full h-[300px] rounded-[32px] overflow-hidden mb-8 group">
                    ...
                    <div className="absolute bottom-8 left-8 text-white space-y-2">
                        <h1 className="text-3xl font-jakarta font-extrabold tracking-tight">{booking.eventTitle}</h1>
                        <div className="flex items-center gap-5">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[13px] font-bold">{booking.creator.rating} Rating</span>
                ...
                <div className="flex flex-col lg:flex-row gap-10 items-start">
                    ...
                    <div className="flex-1 space-y-10">
                        ...
                        <div className="flex items-center gap-3.5">
                            ...
                            <div>
                                <div className="flex items-center gap-2">
                                    <h2 className="text-base font-bold text-black">Hosted by {booking.creator.name}</h2>
                    ...
                    <div className="w-full lg:w-[350px] sticky top-12">
                        <div className="bg-white border-2 border-slate-50 rounded-[32px] p-7 space-y-7">
                            ...
                            <div className="flex items-baseline justify-between">
                                <div className="flex items-baseline gap-2">
                                    <span className="text-2xl font-extrabold text-black">${booking.creator.pricePerHour}</span>
                                    <span className="text-[13px] font-bold text-slate-400 line-through">$25</span>
                                    <span className="text-[12px] font-bold text-slate-400 ml-1">/ session</span>
                                </div>
                            </div>
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="space-y-2" ref={dropdownRef}>
                                    <label className="text-[11px] font-extrabold text-[#A0AEC0] uppercase tracking-wider px-1">Service Type</label>
                                    <div className="relative">
                                        <button 
                                            type="button"
                                            onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                                            className={cn(
                                                "w-full h-12 px-5 bg-[#F8FAFC] border border-[#E2E8F0] rounded-2xl text-[13px] font-bold text-black flex items-center justify-between transition-all outline-none",
                                            ...
                                            <div className="absolute top-[calc(100%+8px)] left-0 right-0 p-1.5 bg-white border border-slate-100 shadow-xl rounded-2xl z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                                                {booking.services.map((s) => (
                                                    <button
                                                        ...
                                                        className={cn(
                                                            "w-full px-4 py-2.5 rounded-xl text-[13px] font-bold text-left flex items-center justify-between transition-colors",
                                ...
                                <div className="space-y-2">
                                    <label className="text-[11px] font-extrabold text-[#A0AEC0] uppercase tracking-wider px-1">Location</label>
                                    <div className="relative group">
                                        <input 
                                            ...
                                            className="w-full h-12 pl-12 pr-5 bg-[#F8FAFC] border border-[#E2E8F0] rounded-2xl text-[13px] font-bold text-black placeholder:text-slate-400 outline-none focus:border-[#FF3B30] focus:ring-4 focus:ring-[#FF3B30]/5 transition-all"
                                        />
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-extrabold text-[#A0AEC0] uppercase tracking-wider px-1">Date</label>
                                        <div className="relative group">
                                            <input 
                                                type="date" 
                                                className="w-full h-12 pl-12 pr-4 bg-[#F8FAFC] border border-[#E2E8F0] rounded-2xl text-[13px] font-bold text-black outline-none focus:border-[#FF3B30] focus:ring-4 focus:ring-[#FF3B30]/5 transition-all cursor-pointer appearance-none"
                                            />
                                            <CalendarIcon className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-slate-400 group-focus-within:text-[#FF3B30] transition-colors" />
                                        </div>
                                    </div>
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-extrabold text-[#A0AEC0] uppercase tracking-wider px-1">Time</label>
                                        <div className="relative group">
                                            <input 
                                                type="time" 
                                                className="w-full h-12 pl-12 pr-4 bg-[#F8FAFC] border border-[#E2E8F0] rounded-2xl text-[13px] font-bold text-black outline-none focus:border-[#FF3B30] focus:ring-4 focus:ring-[#FF3B30]/5 transition-all cursor-pointer appearance-none"
                                            />
                                            <Clock className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-slate-400 group-focus-within:text-[#FF3B30] transition-colors" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    <label className="text-[11px] font-extrabold text-[#A0AEC0] uppercase tracking-wider px-1">Special Notes (Optional)</label>
                                    <textarea 
                                        placeholder="Add any request..."
                                        value={specialNotes}
                                        onChange={(e) => setSpecialNotes(e.target.value)}
                                        rows={2}
                                        className="w-full p-4 bg-[#F8FAFC] border border-[#E2E8F0] rounded-2xl text-[13px] font-bold text-black placeholder:text-slate-300 outline-none focus:border-[#FF3B30] focus:ring-4 focus:ring-[#FF3B30]/5 transition-all resize-none"
                                    />
                                </div>
                            </div>

                            {/* Book Now Button */}
                            <button className="w-full h-14 bg-[#FF3B30] text-white rounded-[20px] text-[15px] font-extrabold uppercase tracking-[0.1em] hover:bg-[#E0352B] transition-all active:scale-[0.98]">
                                BOOK NOW
                            </button>
                            ...
                            <div className="pt-4 border-t border-slate-50 space-y-2">
                                ...
                                <div className="flex justify-between pt-2">
                                    <span className="text-[14px] font-bold text-black">Total Expected</span>
                                    <span className="text-[15px] font-extrabold text-black">$120.00</span>
                                </div>
                            </div>

                            <p className="text-center text-[10px] font-bold text-slate-300 tracking-tight">
                        ...
                        <div className="mt-6 relative w-full h-32 rounded-[28px] overflow-hidden group cursor-pointer">
                            ...
                            <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                                <div className="bg-white/90 backdrop-blur px-5 py-2.5 rounded-xl text-[10px] font-extrabold text-black uppercase tracking-widest hover:bg-white transition-colors">
